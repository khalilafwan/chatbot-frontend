            ...
            <div className="flex flex-col gap-2">
              {message.audio_url && (
                <audio controls className="w-full">
                  <source
                    src={message.audio_url.startsWith("s3://")
                      ? message.audio_url.replace("s3://chatbot-voice-audio-developer/", "https://your-cloudfront-or-s3-url/")
                      : message.audio_url}
                  />
