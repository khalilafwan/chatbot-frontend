...
const suggestedActions = [
    {
        title: 'Bisa jelaskan tentang',
        label: 'Tabungan SIKOCI?',
        action: 'Bisa jelaskan tentang Tabungan SIKOCI?',
    },
    {
        title: 'Keuntungan apa yang didapat dari',
        label: 'Tabungan SIKOCI Bisnis?',
        action: 'Keuntungan apa yang didapat dari Tabungan SIKOCI Bisnis?',
    },
];
...
export const ChatInput = ({ question, setQuestion, onSubmit, isLoading }: ChatInputProps) => {
    ...
    return (
        <div className="relative w-full flex flex-col gap-4">
            ...
            {/* Tombol Chat dan Voice Chat */}
            <div className="absolute bottom-2 right-2 flex gap-2">
                <Button
                    className="rounded-full p-1.5 h-fit border dark:border-zinc-600"
                    onClick={() => {
                        useVoiceChat.getState().open();
                    }}
                    variant="outline"
                >
